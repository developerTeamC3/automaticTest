...
let driver_Edge =  new Builder().forBrowser("MicrosoftEdge").build();
//let driver_fox = new Builder().forBrowser("firefox").build();


searchTest(driver_Edge);
...
console.log("Seleccionar Tipo de Envio");
 ...
 await driver.sleep(3000);
var NumeroOrden = await driver.findElement(By.xpath("//*[@id='maincontent']/div[2]/div[1]/div[1]")).getText();
